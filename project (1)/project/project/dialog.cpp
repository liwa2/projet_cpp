    ...
    ui(new Ui::Dialog)
{
    ...
    ui->id_accommodation_line->setValidator(new QIntValidator(0,999999999,this));
...
void Dialog::on_client_pdf_clicked()
{
    ...
    QPdfWriter pdf("C:/Users/JAXIM/Desktop/Esprit/2eme/project/project (1)/project/client.pdf");
    QPainter painter(&pdf);
